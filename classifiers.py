...
class classifiers:
	...
	def DLDA(self, trainLabel, featureData, testData):
                ...
                dLDA = mlpy.DLDA(delta = 0.1)
		dLDA.learn(featureData, trainLabel)
		testLabel = dLDA.pred(testData).tolist()
	...
	def kNN(self, trainLabel, featureData, testData):
                ...
                print 'testData', testData
		kNNC = mlpy.KNN(3)
		kNNC.learn(featureData, trainLabel)
		testLabel = kNNC.pred(testData).tolist()
		print 'testlabel', testLabel
		return testLabel
	...
	def linSVM(self, trainLabel, featureData, testData):
                ...
                print 'testData', testData
		lSVM = mlpy.LibSvm()
		lSVM.learn(featureData, trainLabel)
		testLabel = lSVM.pred(testData).tolist()
		print 'testlabel', testLabel
